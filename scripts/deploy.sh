...
sudo nohup java -jar $DEPLOY_JAR --spring.config.location=~/.config/.app/.yml/prod.yml >> /home/ubuntu/wanderHub-back/log/deploy.log 2>/home/ubuntu/wanderHub-back/log/deploy_err.log &